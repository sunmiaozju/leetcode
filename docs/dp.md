...
- 分割等和子集。将原来的问题转化为是否可以有部分元素组成某一个数字，组成数字的目标和 target 是代价。这里面没有价值的定义，因为是判断 true 或 false.

- 分割相差最小的两个子集。 转化为有限 01 背包问题，背包的大小就是数组和的一半，然后在这个容量之下，找到最大的价值。[链接](https://blog.csdn.net/qq_26222859/article/details/69335310)
...
- 回文子串一系列问题。 题目 5, 516, 647, 730

- 312. 戳气球. 参考[链接](https://www.cnblogs.com/grandyang/p/5006441.html);
